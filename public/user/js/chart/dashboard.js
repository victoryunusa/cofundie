...
// QR Code
var qrcode = new QRCode({ content: document.getElementById('qrUrl').value, join: true });
var svg = qrcode.svg();
...
function saveSvg(svgEl, name) {
    ...
    var svgBlob = new Blob([svgData], {type:"image/png;charset=utf-8"});
...
$('.download-qr').on('click', function (e) {
    ...
    saveSvg(document.querySelector("#qrcode svg"), document.getElementById('username').value)
})
