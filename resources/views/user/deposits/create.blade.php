                                    ...
                                    <form action="{{ route('user.deposit.make-payment', $gateway->id) }}" method="post" class="ajaxform_with_redirects" enctype="multipart/form-data">
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{ currency_format(convert_money($amount, default_currency()) * $gateway->currency->rate, currency:$gateway->currency) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>{{ __('Gateway Rate') }}</th>
                                                <td>{{ currency_format($gateway->currency->rate)  }}</td>
                                            </tr>
                                            <tr>
                                                <th>{{ __('Payable') }} ({{ $gateway->currency->code }})</th>
                                                <td @class(['inr' => $gateway->currency->code == 'INR'])>
                                                    {{ currency_format((convert_money($amount, default_currency()) * $gateway->currency->rate) + $gateway->charge) }}
                                                </td>
                                            </tr>
