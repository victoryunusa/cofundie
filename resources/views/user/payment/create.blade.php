...
@section('title', __('Make Investment'))
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content mt-4" id="myTabContent2">
                            @foreach($gateways as $key => $gateway)
                                ...
                                >
                                    <form action="{{ route('user.invests.make-payment', $gateway->id) }}" method="post" class="ajaxform_with_redirects" enctype="multipart/form-data">
                                        @csrf
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{ currency_format($amount * $gateway->currency->rate, currency:$gateway->currency) }}
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td @class(['inr' => $gateway->currency->code == 'INR'])>
                                                    {{ currency_format(($amount * $gateway->currency->rate) + $gateway->charge, currency:$gateway->currency) }}
                                                </td>
                                            </tr>
