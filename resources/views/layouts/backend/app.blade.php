...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('plugins/selectric/selectric.css') }}">
    <link rel="stylesheet" href="{{ asset('plugins/select2/select2.min.css') }}">
    <link rel="stylesheet" href="{{ asset('plugins/jquery-confirm-js/jquery-confirm.min.css') }}">
    <link rel="stylesheet" href="{{ asset('plugins/toastifyjs/toastify.css') }}">
...
<script src="{{ asset('plugins/selectric/jquery.selectric.min.js') }}"></script>
<script src="{{ asset('plugins/select2/select2.min.js') }}"></script>
<script src="{{ asset('plugins/toastifyjs/toastify.js') }}"></script>
