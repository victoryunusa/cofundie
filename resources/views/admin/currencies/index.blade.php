                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="btn-group">
                                        @if (!$currency->is_default)
                                            <a
                                                class="btn btn-success action-confirm btn-sm"
                                                href="javascript:void(0)"
                                                data-action="{{ route('admin.currencies.make.default', $currency->id) }}"
                                                data-method="PUT"
                                                data-text="{{ __('The :name currency make as default?', ['name' => $currency->name]) }}"
                                                data-toggle="tooltip"
                                            >
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-danger btn-sm has-icon action-confirm" data-action="{{ route('admin.currencies.destroy', $currency->id) }}" data-icon='fas fa-trash' data-method="DELETE">
