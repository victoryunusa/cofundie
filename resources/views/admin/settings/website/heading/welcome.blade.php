                    ...
                    <form class="ajaxform" action="{{ route('admin.settings.website.heading.update-welcome') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            {{ mediasection([
                                ...
                                'preview_class' => 'welcome_image_'.$key,
                        ...
                        <div class="form-group">
                            <label for="welcome_background_image_1_{{ $key }}" class="required">{{ __('Background Image (Shape 1)') }} ({{ $key }})</label>
                            {{ mediasection([
                                'input_name' => 'background_image_1',
                                'input_id' => 'welcome_background_image_1_'.$key,
                                'preview_class' => 'welcome_background_image_1_'.$key,
                                'preview' => $headings['heading.welcome'][$key]['background_image_1'] ?? null,
                                'value' => $headings['heading.welcome'][$key]['background_image_1'] ?? null
                            ]) }}
                        </div>

                        <div class="form-group">
                            <label for="welcome_background_image_1_{{ $key }}" class="required">{{ __('Background Image (Shape 2)') }} ({{ $key }})</label>
                            {{ mediasection([
                                'input_name' => 'background_image_2',
                                'input_id' => 'welcome_background_image_2_'.$key,
                                'preview_class' => 'welcome_background_image_2_'.$key,
                                'preview' => $headings['heading.welcome'][$key]['background_image_2'] ?? null,
                                'value' => $headings['heading.welcome'][$key]['background_image_2'] ?? null
                            ]) }}
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {{ mediasection([
                                ...
                                'preview' => $headings['heading.welcome'][$key]['animate_image'] ?? null,
                                'value' => $headings['heading.welcome'][$key]['animate_image'] ?? null
                            ]) }}
                        </div>
