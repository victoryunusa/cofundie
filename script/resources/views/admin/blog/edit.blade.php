                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="from-group row mb-2">
                                        ...
                                        <div class="col-lg-12">
                                            <textarea name="metatag" cols="30" rows="10" class="form-control">{{ $page->metatag->value ?? '' }}</textarea>
                                        </div>
                                    </div>
                                    <div class="from-group row mb-2">
                                        <label for="" class="col-lg-12">{{ __('Meta Description :') }} </label>
                                        <div class="col-lg-12">
                                            <textarea name="metadescription" cols="30" rows="10" class="form-control">{{ $page->metadescription->value ?? '' }}</textarea>
                                        </div>
                                    </div>
                                    <div class="from-group row mb-2">
                                        <label for="" class="col-lg-12">{{ __('Content :') }} </label>
                                        <div class="col-lg-12">
                                            <textarea name="description" class="summernote">{{ $page->description->value ?? '' }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="from-group row mb-2">
                                        ...
                                        <div class="col-lg-12">
                                            <select name="featured" class="form-control">
                                                <option value="1" @if ($page->featured == 1) selected @endif>
                                                    {{ __('Active') }}</option>
                                                <option value="0" @if ($page->featured == 0) selected @endif>
                                                    {{ __('Inactive') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="from-group row mb-2">
                                        ...
                                        <div class="col-lg-12">
                                            <select name="comment_status" class="form-control">
                                                <option value="1" @if ($page->comment_status == 1) selected @endif>
                                                    {{ __('Active') }}</option>
                                                <option value="0" @if ($page->comment_status == 0) selected @endif>
                                                    {{ __('Inactive') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="from-group row mb-2">
                                        ...
                                        <div class="col-lg-12">
                                            <select name="lang" class="form-control">
                                                @foreach (get_option('languages') as $key => $row)
                                                    <option value="{{ $key }}"
                                                        @if ($page->lang == $key) selected="" @endif>
                                                        {{ __($row) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
...
@push('script')
    ...
    <script src="{{ asset('plugins/dropzone/components-multiple-upload.js') }}"></script>
