                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.customers.update', $customer->id) }}" class="ajaxform_with_redirect">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="business_name" id="business_name" class="form-control" value="{{ $customer->meta['business_name'] }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" name="wallet" class="form-control" placeholder="{{ __('Wallet Balance') }}" value="{{ $customer->wallet }}">
                            </div>
                        </div>
